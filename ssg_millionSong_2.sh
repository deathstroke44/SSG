...
./test_nndescent $BASE_PATH $EFANNA_GRAPH 50 50 12 10 50 > $EFANNA_LOG
...
./build/tests/test_ssg_index $BASE_PATH $EFANNA_GRAPH 50 50 60 $SSG_GRAPH > $SSG_LOG
