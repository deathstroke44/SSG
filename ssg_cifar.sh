...
taskset --cpu-list 65-65 ./test_nndescent $SIFT_PATH/base.fvecs $INDEX_PATH/cifar_100nn.knng 20 20 12 10 100 > $LOG_PATH/efannlogcifar1.txt

cd /data/kabir/similarity-search/models/SSG/

taskset --cpu-list 65-65 ./build/tests/test_ssg_index $SIFT_PATH/base.fvecs $INDEX_PATH/cifar_100nn.knng 20 50 60 $INDEX_PATH/cifar.ssg > $LOG_PATH/ssgbuildlogcifar1.txt
