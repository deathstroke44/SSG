...
taskset --cpu-list 64-64 ./test_nndescent $SIFT_PATH/base.fvecs $INDEX_PATH/enron_100nn.knng 20 100 12 10 100 > $LOG_PATH/efannlogenron1.txt

cd /data/kabir/similarity-search/models/SSG/

taskset --cpu-list 64-64 ./build/tests/test_ssg_index $SIFT_PATH/base.fvecs $INDEX_PATH/enron_100nn.knng 20 50 60 $INDEX_PATH/enron.ssg > $LOG_PATH/ssgbuildlogenron1.txt
